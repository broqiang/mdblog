// 这个 tree 文件直接复制的 https://github.com/julienschmidt/httprouter/blob/master/tree.go
// 感谢作者，路由封装的思路多数都是参考的 julienschmidt/httprouter ，此处只做了极少的修改
...
// Param 是一对参数的 key 和 value
type Param struct {
	Key   string
	Value string
}

// Params 是一组 Param 的 slice
type Params []Param
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handlers Handlers) {
...
// given path.
func (n *node) getValue(path string) (handlers Handlers, p Params, tsr bool) {
