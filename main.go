...
func main() {
	...
	// 创建并启动服务器，传入嵌入的资源
	srv := server.NewServerWithAssets(serverHost, serverPort, dataManager, &EmbeddedAssets)

	log.Printf("启动服务器: %s:%d", serverHost, serverPort)
